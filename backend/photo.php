    ...
    <form method="post" action="api/edit.php">
        <table width="100%">
            <tbody>
                ...
                ?>
                <tr>
                    <td width="45%"><img src='img/<?=$row['img'];?>' style="width:200px"></td>
                    ...
                    <td><input type="button" value="更新圖片"
                            onclick="op('#cover','#cvr','modal/upload_photo.php?id=<?=$row['id'];?>&table=<?=$table;?>')">
                    </td>
            ...
            <tbody>
                <tr>
                    <td width="200px"><input type="button"
                            onclick="op(&#39;#cover&#39;,&#39;#cvr&#39;,&#39;modal/photo.php?table=<?=$table;?>&#39;)"
                            value="新增圖片"></td>
